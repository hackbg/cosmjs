...
export const ModuleAccountPermission = {
  encode(message: ModuleAccountPermission, writer: __m0.Writer = _m0.Writer.create()): __m0.Writer {
    if (message.account !== "") {
  ...
  decode(input: __m0.Reader | Uint8Array, length?: number): ModuleAccountPermission {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
